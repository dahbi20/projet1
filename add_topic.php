 ...
 <a href="teacher_dashboard.php"><li> Classes
  ...
  Ajouter le sujet
    ...
    <form  method="POST">
     ...
     <input type="Text" name="topic" placeholder="Entrez dans le sujet..." style="padding: 4px 5px;margin-left: 50px;width: 20em;border:3px solid rgba(85, 85, 85, 0.6);">
