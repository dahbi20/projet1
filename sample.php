...
<div class="container">
  ...
  <form method="post" action="success.php" name="payuForm">
    ...
    <button type="submit">Payer pour la microéconomie - 1000 / -</button>
  </form>
  <!-- Trigger the modal with a button -->
  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Modal ouvert</button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Abonnez-vous à notre service</h4>
        </div>
